...
class SideNav extends React.Component{
    ...
    render()
    {
            ...
            <div className="sidenav" style={{fontFamily: '\'Singlet\',cursive'}}>
                        ...
                        <a style={this.state.active.b3?{color: '#67ce63'}:{color:'#818181'}} onClick={()=>{this.onLibClick();this.props.onRouteChange('home');}} href="#"><i className="icon server">&nbsp;&nbsp;Library</i></a><br/>
