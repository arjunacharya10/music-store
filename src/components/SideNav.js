...
class SideNav extends React.Component{
    ...
    render()
    {
            ...
            <div style={{cursor:'pointer'}} className="sidenav" style={{fontFamily: '\'Lato\', sans-serif'}}>
                        ...
                        <a style={this.state.active.b4?{color: '#ffffff',fontFamily: '\'Lato\', sans-serif'}:{color:'#818181',fontFamily: '\'Lato\', sans-serif'}} onClick={()=>{this.onAboutClick();this.props.onRouteChange('about');}} style={{marginTop: '100px'}} href="#"><i className="icon">&nbsp;&nbsp;About</i></a><br/>
