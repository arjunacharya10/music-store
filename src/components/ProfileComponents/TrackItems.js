...
const TrackItems =({track,setSongUrl})=>{
    ...
    return(
            ...
            <div className='tc  dib br3 pa3 ma2' style={{marginTop:'50px'}}>
			 <a style={{color: 'white',cursor:'pointer'}} onClick={()=>{setSongUrl(track.id)}}><img className="ui circular medium image grow" src={trackImage} alt="robots"/></a>
			<div>
				<h2>{trackName} </h2>
				<p>{artistNames}&nbsp;&nbsp;&nbsp;&nbsp;</p>
			</div>
